...
logger = configure_logger('alerts')
...
def send_email(subject: str, body: str):
    logger.info('send_email', extra={'subject': subject, 'to': settings.alerts.smtp_to})
...
def send_splunk_hec(event: Dict[str, Any]):
    logger.info('send_splunk_hec', extra={'event_keys': list(event.keys())})
